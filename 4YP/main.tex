...
\title{\LARGE \bf Evaluation and Deployment of LiDAR-based Place Recognition in Dense Forests}
...
% The level that gets a number:In this section, we will discuss the system setup and the implementation of our
...
% Title page is created hereIn this section, we will discuss the system setup and the implementation of our
\maketitle
