...
%\haedam{Nived Can you check this? "
% However, those methods are susceptible to occlusions and outliers in dense forest environments and long-term changes in the environment." we did not test this but can I write this sentence here?}
...
% \mfallon{why does the previous paragraph exist? It's not related work - its about the method. Can you shorten it significantly. Perhaps its sufficient to just include the first sentance and move the part about our dataset to the results section.}
% \haedam{Okay}
% \mfallon{Of course we should publish the datasets with the paper.}
% \haedam{So should I say we will upload dataset here ..? }
