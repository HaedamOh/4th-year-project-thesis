...
% \mfallon{we should discuss this comment here - I dont know what it means: moredicussion.. marginal covariance details?}
...
\end{equation}
If this difference is more than a threshold of \SI{10}{\centi\meter} or \SI{1}{\degree} we reject the candidate. This is shown in \figref{fig:cycle-consistency}, please refer to the corresponding sections for further details.
