...
The author of Logg3dNet proposed SGV check for reranking top-$k$ candidates obtained from descriptor distance matching in \secref{subsubsec:loop-candidate}. But, instead we used SGV for verifying registration quality when their baseline distance is far apart. 
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\columnwidth]{pics/methods_factor_graph_v2}
