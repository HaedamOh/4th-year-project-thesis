...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.99\linewidth]{pics/exp_4_relocalization_before_after2.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{pics/exp_4_relocalization_pairwise_before_after3.pdf}
...
The ICP threshold should be fine-tuned to $\sim$ 3k-5k points depending on the LiDAR setup and forest environments. There is trade-off between the baseline distance and the robustness of the loop-closure as shown in \figref{fig:icp_inliers_num}. For an example, in the Evo dataset, we set the threshold to 3k points, whereas in the Wytham Woods, we set the higher threshold to 4k-5k points. \\
 \begin{figure}[t]
  \centering
