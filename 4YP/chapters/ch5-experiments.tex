...
\begin{figure}[htbp]
  ...
  \caption{Offline multi-mission SLAM point clouds output for Evo.}
...
top-1 to top-5 candidates implemented with parallel computations threading for RANSAC registration. 
